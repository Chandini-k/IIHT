...
{
    public partial class IIHT_modDBContext : DbContext
    {
        public IIHT_modDBContext()
        {
        }

        public IIHT_modDBContext(DbContextOptions<IIHT_modDBContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("server=PCIN480238;database=IIHT_modDB;trusted_connection=yes");
            }
        }
